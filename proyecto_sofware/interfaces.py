"""
Interfaz Streamlit - El Refugio
=================================
Gestión de Pedidos, Inventario e Ingresos diarios.
...
# =========================================================
# INICIALIZACIÓN (una sola vez, se guarda en session_state)
# =========================================================
...
# =========================================================
# BARRA LATERAL DE NAVEGACIÓN (disponible en todas las pantallas)
# =========================================================
with st.sidebar:
    st.title("🍔 El Refugio")
...
# =========================================================
# ENRUTADOR: muestra la pantalla según st.session_state.pagina
# =========================================================
PANTALLAS = {
